class Email:
	...
	def __init__(self,
		...
		self.PAR_2 = '''
					\nThe Berkeley Art Museum and Pacific Film Archive (BAMPFA) has received a grant [link to project blog post] from the Council on Library and Information Resources (CLIR) to digitize nearly 800 audio cassette tapes of guest speakers at the Pacific Film Archive, recorded between 1976 and 1986. As part of this project, we have digitized one or more audio recordings in which you were a participant.\n
					'''
		self.PAR_3 = '''
					The following recording date(s) represent your contributions to this collection that have been digitized:\n
					'''
		...
		self.PAR_7 = '''
					...
					'''
		self.PAR_8 = '''
					Please complete this two-question Google form [link] to record your response to our request.\n
					'''
		self.PAR_9 = '''
	...
	def is_deceased(self):
		self.PAR_1 = "To the estate of {} ('THE ESTATE'):".format(self.name)
...
PAR_4 = '' # list of event dates

PAR_5 = '\n\nThe following film titles were discussed in the above recordings:\n\n'

PAR_6 = '' # List of film titles

PAR_7 = '''
\nAs part of the educational mission of this project, BAMPFA respectfully requests your permission to make these recordings available online via educational partners such as the Internet Archive and/or the BAMPFA website. This project also enables us to preserve these works for researchers into the future as digital formats change. Please note that speakers retain copyright to their content unless they explicitly waive copyright.\n
'''
...
PAR_11 = 'Michael Campos-Quinn and Jason Sanders\n'

PAR_11 = 'BAMPFA Film Library and Study Center'

letterPars = [PAR_1,PAR_2,PAR_3,PAR_4,PAR_5,PAR_6,PAR_7,PAR_8,PAR_9,PAR_10,PAR_11]
